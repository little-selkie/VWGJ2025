...
var hospital_upgrades: Array[Array] = [
	...
	["More Health production", load("res://icon.svg"), "Will generate 25% more health", more_production, "Type", 10, 10],
	...
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
...
var park_upgrades: Array[Array] = [
	["More Mental Health production", load("res://icon.svg"), "Will generate +25% more mental health", more_production, "Type", 10, 10],
	["More Mental Health production", load("res://icon.svg"), "Will generate +25% more mental health", more_production, "Type", 10, 10],
	["Even More Mental Health production", load("res://icon.svg"), "Will generate +25% more mental health", more_production, "Type", 10, 10],
	["Autonomy", load("res://icon.svg"), "Needs less energy to function", autonomy, "Type", 10, 10],
	["Top Specialists", load("res://icon.svg"), "25% Cheaper to repair", cheaper_repairs, "Type", 10, 10],
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
...
var civilian_upgrades: Array[Array] = [
	["More energy per day", load("res://icon.svg"), "Less mental health depletion when off, but needs more energy to function", less_mental_health_depletion, "Type", 10, 10],
	["Autonomy", load("res://icon.svg"), "Needs less energy to function", autonomy, "Type", 10, 10],
	["Top Specialists", load("res://icon.svg"), "25% Cheaper to repair", cheaper_repairs, "Type", 10, 10],
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
...
var heating_upgrades: Array[Array] = [
	["Night Shifts", load("res://icon.svg"), "Unlocks working during night hours", night_shift, "Type", 10, 10],
	["More Heating production", load("res://icon.svg"), "Will generate 25% more heating", more_production, "Type", 10, 10],
	["Autonomy", load("res://icon.svg"), "Needs less energy to function", autonomy, "Type", 10, 10],
	["Top Specialists", load("res://icon.svg"), "25% Cheaper to repair", cheaper_repairs, "Type", 10, 10],
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
...
var laboratory_upgrades: Array[Array] = [
	["Night Shifts", load("res://icon.svg"), "Unlocks working during night hours", night_shift, "Type", 10, 10],
	["More Technology production", load("res://icon.svg"), "Will generate +25% more technology", more_production, "Type", 10, 10],
	["Even more Technology production", load("res://icon.svg"), "Will generate +25% more technology", more_production, "Type", 10, 10],
	["Autonomy", load("res://icon.svg"), "Needs less energy to function", autonomy, "Type", 10, 10],
	["Top Specialists", load("res://icon.svg"), "25% Cheaper to repair", cheaper_repairs, "Type", 10, 10],
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
...
var power_upgrades: Array[Array] = [
	["Solar Panels", load("res://icon.svg"), "Gives Extra 3 Energy during the Day", solar_panels, "Type", 10, 4],
	["Solar Panels+", load("res://icon.svg"), "Gives additional Extra 3 Energy during the Day", solar_panels, "Type", 10, 4],
	["Top Specialists", load("res://icon.svg"), "25% Cheaper to repair", cheaper_repairs, "Type", 10, 10],
	["Top Specialists+", load("res://icon.svg"), "25% Faster to repair", faster_repairs, "Type", 10, 10],
	["Basic Shelter", load("res://icon.svg"), "Will protect 25% of People Health upon Strike", shelters, "Type", 10, 10],
	["Advanced Shelter", load("res://icon.svg"), "Will protect 75% of People Health upon Strike", shelters, "Type", 10, 10]
