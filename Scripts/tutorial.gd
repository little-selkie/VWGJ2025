...
var tutorial_steps: Array[Array] = [
	...
	["You will also have to keep an eye on these indicators: [br][b]Mental Health[/b] [img=64x64]res://Icons/Upgrades/Mental_Health.png[/img] - general state of the population, affects the Finances [img=64x64]res://Icons/Upgrades/Money.png[/img] generation. [br][b]Physical Health[/b] [img=64x64]res://Icons/Upgrades/Physical_Health_.png[/img] - affects generation rate of all resources [b]except[/b] Power [img=64x64]res://Icons/Upgrades/Electricity.png[/img]. [br][b]Protection[/b] [img=64x64]res://Icons/Upgrades/Air_Defense_.png[/img] - affects the frequency of shellings. This is the main indicator you need to fill to win the game.", load("res://Icons/Tutorial/tutorial3.png"), "Indicators"],
	["You have 8 districts, each with it's own purpose, they generate resources [b]only during the Day[/b]. Use Power [img=64x64]res://Icons/Upgrades/Electricity.png[/img] to keep districts working, but this resource is [b]not[/b] generated over time - you have limited amount to share between districts, so choose your priorities wisely. [br]If you want to increase the amount of Power [img=64x64]res://Icons/Upgrades/Electricity.png[/img] or to generate resources during the Night, use can always go for Upgrades.", load("res://Icons/Tutorial/tutorial4.png"), "Districts"],
	["There are two types of Upgrades available: [br][b]District Upgrades[/b] - to increase productivity in your district. [br][b]General Upgrades[/b] - to improve your city as a whole. [br]You can hover over the Upgrade icons to learn more about what they can do for you.", load("res://Icons/Tutorial/tutorial5.png"), "Upgrades"],
	["You just managed to find a balance in the infrastructure, but [b]BAM![/b] - one of your districts has been shelled :( [br]Be sure to spend Finances [img=64x64]res://Icons/Upgrades/Money.png[/img] to fix the affected district, but also don't forget to invest in Protection [img=64x64]res://Icons/Upgrades/Air_Defense_.png[/img] to reduce shelling frequency.", load("res://Icons/Tutorial/tutorial6.png"), "Shellings"],
	...
	["So, your city is running smoothly, everything is in order? [br]To [b]Win[/b] you have to have your city Protected [img=64x64]res://Icons/Upgrades/Air_Defense_.png[/img] at MAX, which can be achieved by upgrading Diplomacy [img=64x64]res://Icons/Upgrades/Diplomacy_1.png[/img] in the Government district. [br]But if you reach bankruptcy - the game will end.", load("res://Icons/Tutorial/tutorial8.png"), "Win or lose"]
]
